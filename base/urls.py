...
urlpatterns = [
    ...
    path('participant/events/<int:event_id>/', views.participant_event_detail, name='participant_event_detail'),
    path('participant/events/<int:event_id>/qr/', views.generate_event_qr, name='generate_event_qr'),
